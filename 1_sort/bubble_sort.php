...
for ($i = 0; $i < $num; $i++) {//下标从0开始
    ...
    list($name, $score) = explode(' ', $input);//用空格区分
...
for ($i = 0; $i < $num - 1; $i++) {//如果有5个数，则只比较4此就可以
    ...
    //例如原版就是4、3、2、1顺序排列的，那遍历第一个时$flag一直为true，那就直接说明已排序好了，跳出即可
    if($flag){
        break;
    }
}
